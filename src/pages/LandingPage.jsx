...
export default function LandingPage() {
  ...
  const handleAppleLogin = () => {
    base44.auth.loginWithProvider('apple', '/app');
  };
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1">
        <section className="max-w-3xl mx-auto px-6 py-20 text-center space-y-6">
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.5 }} className="flex flex-col items-center gap-3">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 bg-black text-white rounded-xl px-6 py-3 text-sm font-medium hover:bg-black/90 transition-colors w-48"
            >
