...
export const translations = {
  it: {
    ...
    freeLimit: 'Hai usato i tuoi 2 render gratuiti oggi. Acquista un pacchetto crediti per continuare senza watermark.',
    ...
    freeTierDesc: '🎨 Piano Gratuito — 2 render al giorno con filigrana SketchForge',
  },
  en: {
    appSubtitle: 'Industrial Design AI',
    ...
    selected: 'selected',
    freeLimit: 'You have used your 2 free renders today. Buy a credit pack to continue without watermark.',
